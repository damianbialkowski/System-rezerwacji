        ...
        <div class="container-fluid">
                            ...
                            <div class="col-md-8">
                                <a href="{{ $item->url }}" class="link_post" id="post_{{$key}}">
                                    <div class="post_main post_bigger">
                                        <img
                                            src="{{ $item->getMedia('images')->first() ? $item->getMedia('images')->first()->getFullUrl() : '' }}"
                                            title="{{ $item->title }}" class="post_main_img img-fluid" alt="top">
            ...
            @foreach($categories as $category)
                @if($category->getCategoryArticles()->count())
                    <section class="category_posts" data-name="{{ $category->name }}"
                        ...
                        <div class="row post_list">
                                ...
                                @foreach($category->getCategoryArticles()->get() as $article)
                                    ...
                                    <a href="{{ $article->url }}" class="link_post">
                                        <div class="post_category space_top">
                                            <img
                                                src="{{ $article->getMedia('images')->first() ? $article->getMedia('images')->first()->getFullUrl() : '' }}"
                                                class="post_logo" title="{{ $article->title }}">
                            ...
                            <i class="fas fa-chevron-right"></i>
                                ...
                                <div class="btn_more_posts">
                                    <a href="{{ $category->url }}">Więcej <span><i
